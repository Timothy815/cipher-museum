...
function App() {
  ...
  return (
    <div className="flex-1 bg-[#1c1a16] flex flex-col">
      <ExhibitPanel id="enigma-i" />
      <div className="bg-[#1c1a16] flex flex-col items-center justify-start py-10 px-6 text-stone-200">
