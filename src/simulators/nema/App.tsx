...
function App() {
  ...
  return (
    <div className="flex-1 bg-[#141418] flex flex-col">
      <ExhibitPanel id="nema" />
      <div className="bg-[#141418] flex flex-col items-center justify-start py-10 px-6 text-neutral-200">
      {/* Header */}
