...
const App: React.FC = () => {
  ...
  const handleLoadConfig = useCallback((loadedState: any) => {
    setState(loadedState as TypexState);
    setHistory([]);
    setTape('');
    setTrace(null);
    setPressedKey(null);
  ...
  return (
    <div className="flex-1 bg-slate-950 flex flex-col items-center px-4 py-8 text-slate-200">
      <div className="w-full max-w-5xl">
        ...
        {/* ── Config Slots ────────────────────────────────────── */}
        <div className="mb-4">
          <ConfigSlots machineId="typex-wiring" currentState={state} onLoadState={handleLoadConfig} accentColor="emerald" />
        </div>
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-4 mb-6">
            <div className="flex justify-between items-center mb-2">
              ...
              <div className="flex items-center gap-2">
                <TapeActions outputText={tape} onProcessInput={handlePasteInput} accentColor="emerald" />
