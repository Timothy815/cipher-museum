...
function App() {
  ...
  return (
    <div className="flex-1 bg-[#141010] flex flex-col">
      <ExhibitPanel id="chaocipher" />
      <div className="bg-[#141010] flex flex-col items-center justify-start py-10 px-6 text-stone-200">
