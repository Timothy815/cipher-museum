...
const machines = [
  ...
  {
    path: '/enigma-i-wiring',
    name: 'Enigma I Wiring Explorer',
    subtitle: '3-Rotor Signal Tracer',
    country: 'Educational',
    era: '1930',
    icon: <Route size={32} />,
    color: 'amber',
    description: 'Trace the electrical signal through the 3-rotor Enigma I — forward through rotors, reflector bounce, and return path. See how plugboard, ring settings, and double-stepping work.',
  },
  {
    path: '/enigma-wiring',
  ...
  {
    path: '/typex-wiring',
    name: 'Typex Wiring Explorer',
    subtitle: '5-Rotor Signal Tracer',
    country: 'Educational',
    era: '1937',
    icon: <Route size={32} />,
    color: 'emerald',
    description: 'Trace the signal through all 5 Typex rotors — 2 fixed stators plus 3 stepping rotors — and the reflector. See how stators add security without moving.',
  },
  {
    path: '/m209',
    name: 'M-209',
  ...
  {
    path: '/nema-wiring',
    name: 'NEMA Wiring Explorer',
    subtitle: '4-Rotor Signal Tracer',
    country: 'Educational',
    era: '1947',
    icon: <Route size={32} />,
    color: 'sky',
    description: 'Trace the signal through NEMA\'s 4 rotors and reflector. See the drive wheel stepping mechanism and how Swiss engineers improved on Enigma\'s design.',
  },
  {
    path: '/red',
    name: 'RED (Type 91)',
  ...
  {
    path: '/hebern-wiring',
    name: 'Hebern Wiring Explorer',
    subtitle: 'Single Rotor Signal Tracer',
    country: 'Educational',
    era: '1918',
    icon: <Route size={32} />,
    color: 'teal',
    description: 'See how a single rotor scrambles the alphabet. The simplest wiring visualization — trace the signal through one rotor that steps with each keypress.',
  },
  {
    path: '/caesar',
    name: 'Caesar Cipher',
...
const modernCrypto = [
  {
    ...
    icon: <Waves size={32} />,
    color: 'cyan',
    description: 'The building block of stream ciphers. A shift register whose input bit is a linear function of its previous state. Used in A5/1, GPS, and CDMA.',
  },
  {
    path: '/des',
    name: 'DES',
    ...
    icon: <Box size={32} />,
    color: 'cyan',
    description: 'The first federal encryption standard. 16-round Feistel network with 56-bit key. Visualize S-boxes, permutations, and the key schedule round by round.',
  },
  {
    path: '/aes',
    name: 'AES',
    ...
    color: 'cyan',
    description: 'The world\'s most widely used cipher. Watch SubBytes, ShiftRows, MixColumns, and AddRoundKey transform the 4×4 state matrix through 10 rounds.',
  },
  {
    path: '/salsa20',
    name: 'Salsa20',
    subtitle: 'ARX Stream Cipher',
    country: 'United States',
    era: '2005',
    icon: <Droplets size={32} />,
    color: 'cyan',
    description: 'Daniel Bernstein\'s elegant stream cipher using only Add, Rotate, XOR. eSTREAM finalist. Visualize the quarter-round mixing on a 4×4 word matrix.',
  },
  {
    path: '/chacha20',
    name: 'ChaCha20',
    subtitle: 'TLS 1.3 Stream Cipher',
    country: 'United States',
    era: '2008',
    icon: <Wind size={32} />,
    color: 'cyan',
  ...
  },
  {
    path: '/rc4',
    name: 'RC4',
    subtitle: 'Rivest Cipher 4 (Broken)',
    country: 'United States',
    era: '1987',
    icon: <Flame size={32} />,
    color: 'orange',
